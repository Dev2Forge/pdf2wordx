...
> Nota: El archivo principal es [pdftoword-v2.1.0](code/pdftoword-v2.1.0.pyc) el directorio de ejecución debe ser tal cual a [este](code), ya que es el que maneja los errores y antes de ejecutar el principal. Descargar la última release es lo mejor, By SRM
